    ...
    const htmlContent = `
      ...
      <body>
        <div class="container">
          ...
          <div class="content-note">
            Welcome to something different. You've joined a select group of ambitious professionals who understand that the future belongs to those who move with intention.
          </div>
          ...
          <div class="content-note" style="margin-top: 30px; font-size: 0.8rem; color: #000000; font-weight: 400;">
            Under evaluation<br>
            — Locus
          </div>
